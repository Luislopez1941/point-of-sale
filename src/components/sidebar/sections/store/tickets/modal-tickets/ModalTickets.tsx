                    ...
                    <div className='tbody__container' key={index}>
                      ...
                      <div className='tbody-response'>
                        ...
                        <div className='td movil'>
                          <input className={`inputs__general`} type='text' value={item?.cantidad === null ? '' : item?.cantidad} onChange={(e) => handleAmountChange(e, index)} placeholder='Cantidad' />
                        </div>
                        <div className='td'>
