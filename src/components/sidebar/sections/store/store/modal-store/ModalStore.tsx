...
const ModalStore = () => {
  ...
  const addStore = () => {
    setWarehouses([...warehouses, fields])
  }
  ...
  const createStore = async () => {
    try {
      let result: any = await APIs.cresteWarehouses(fields); // Crear el almacén
      ...
      // Obtener nuevamente los almacenes
      const data = {
        companyId: 0,
        branchId: 0
      };

      const response: any = await APIs.getWarehouses(data);
      ...
      Swal.fire({
        ...
        text: 'Hubo un problema al guardar el almacén. Intenta nuevamente.',
      });
  ...
  return (
    <div className={`overlay__store_modal ${modalState === 'store_modal' ? 'active' : ''}`}>
      <div className={`popup__store_modal ${modalState === 'store_modal' ? 'active' : ''}`}>
        ...
        <form className='store_modal' onSubmit={createAdministrator}>
          <div className='store_modal_container'>
            ...
            <div className='table_store_modal' >
              <div>
                {warehouses ? (
            ...
            <div className='row__three'>
              <button className='btn__general-primary' onClick={createStore}>Crear almacén</button>
            </div>
