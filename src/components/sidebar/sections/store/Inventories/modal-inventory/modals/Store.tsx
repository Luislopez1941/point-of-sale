...
import { setModal, setStore } from '../../../../../../../redux/state/store/Inventory';
...
const Store: React.FC = () => {
    ...
    const addStore = () => {
        dispatch(setStore([...store, select.selectedItems.store]))
    }

     const deleteStore = (_: any, i: number) => {
            let filter = store.filter((_: any, index: any) => index !== i)
            console.log(filter)
            dispatch(setStore(filter))
        }
    

    return (
        <div className={`overlay__store_modal-product ${modalState === 'store_modal-product' ? 'active' : ''}`}>
            <div className={`popup__store_modal-product ${modalState === 'store_modal-product' ? 'active' : ''}`}>
                <div className='header__modal'>
                    <a href="#" className="btn-cerrar-popup__store_modal-product" onClick={() => handleModalChange('')}>
                        <svg className='svg__close' xmlns="http://www.w3.org/2000/svg" height="16" width="12" viewBox="0 0 384 512"><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" /></svg>
                    </a>
                    <p className='title__modals'>Nuevo almacén</p>
                </div>
                <div className='store_modal-product'>
                    ...
                    <div className='row__two'>
                        <div>
                            <Select dataSelects={result} instanceId="store" nameSelect="Almacenes"/>
                        </div>
                        <div>
                                ...
                                {store?.map((item: any, index: any) => (
                                    <div className='tbody__container' key={index}>
                                        <div className='tbody-desk'>
                                            ...
                                            <div className='td'>
                                                <div className='delete-icon' onClick={() => deleteStore(item, index)}>
